...
import org.springframework.data.repository.query.Param; // <-- CRITICAL: Kept this for your ML query!
...
public interface ReportRepository extends JpaRepository<ElephantReport, Long> {
    ...
    // [YOUR CODE] For String type - convert to Enum safely
    ...
    // [FRIEND's CODE] Added this method for user-specific reports
    ...
    // [YOUR CODE] For String type safely
    ...
    // ====================================================================================
    // --- [YOUR CODE] AI ML HELPER METHOD ---
    // Calculates the total number of elephants reported within a specific radius
    // in the last 3 hours using the Haversine formula directly inside MySQL!
    // ====================================================================================
